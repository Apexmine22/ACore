...
public class BanManager {
    ...
    public static Ban createBan(final String playerName, final String admin, final String reason, final long time, final String comment, final BanType type) {
        ...
        ACore.getInstance().getMySQL().execute("INSERT INTO `Ban` (`username`, `admin`, `reason`, `time`, `comment`, `type`, `expire`) VALUES ('" + MySQL.strip(playerName.toLowerCase()) + "','" + MySQL.strip(admin) + "','" + MySQL.strip(reason) + "','" + time + "','" + MySQL.strip(comment) + "','" + type + "','" + System.currentTimeMillis() + "')");
        return ban;
    }
    ...
    public static void unBan(final String playerName) {
        ...
        ACore.getInstance().getMySQL().execute("DELETE FROM `Ban` WHERE `username`='" + MySQL.strip(playerName.toLowerCase()) + "'");
    }
    ...
    public static Ban createMute(final String playerName, final String admin, final String reason, final long time, final String comment, final BanType type) {
        ...
        ACore.getInstance().getMySQL().execute("INSERT INTO `Mute` (`username`, `admin`, `reason`, `time`, `comment`, `type`, `expire`) VALUES ('" + MySQL.strip(playerName.toLowerCase()) + "','" + MySQL.strip(admin) + "','" + MySQL.strip(reason) + "','" + time + "','" + MySQL.strip(comment) + "','" + type + "','" + System.currentTimeMillis() + "')");
        return ban;
    }
    ...
    public static void editBan(final Ban ban) {
        ...
        ACore.getInstance().getMySQL().execute("UPDATE `Ban` SET `time`='" + bban.getTimeLeft() + "' WHERE `username`='" + MySQL.strip(bban.getName()) + "'");
    ...
    public static void editMute(final Ban ban) {
        final Ban bban = new Ban(MySQL.strip(ban.getName()), MySQL.strip(ban.getAdmin()), MySQL.strip(ban.getReason()), ban.getTimeLeft(), MySQL.strip(ban.getComment()), ban.getType(), ban.getExpire());
        ACore.getInstance().getMySQL().execute("UPDATE `Mute` SET `time`='" + bban.getTimeLeft() + "' WHERE `username`='" + MySQL.strip(bban.getName()) + "'");
    ...
    public static void unMute(final String playerName) {
        ...
        ACore.getInstance().getMySQL().execute("DELETE FROM `Mute` WHERE `username`='" + MySQL.strip(playerName.toLowerCase()) + "'");
    }
